...
class BestieSidebarItem {
  ...
  final String label;
  final String route;
  const BestieSidebarItem({required this.icon, required this.label, required this.route});
}
...
class BestieSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final width = collapsed ? BestieTokens.sidebarWCollapsed : BestieTokens.sidebarW;
